...
//	public static String directory=".\\src\\file"; //相对目录
	...
	public static String EntityName="ToFundWarehouseTime";
	public static String note="仓库吨数分布表";//注释
	public static String tableName="to_fund_warehouse_time";//实体表名
	 /**
