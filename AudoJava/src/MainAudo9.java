...
//	public static String directory=".\\src\\file"; //相对目录
	...
	public static String EntityName="ToFundGoodTime";
	public static String note="货物存量表";//注释
	public static String tableName="to_fund_good_time";//实体表名
	 /**
