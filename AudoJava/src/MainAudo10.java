...
//	public static String directory=".\\src\\file"; //相对目录
	...
	public static String EntityName="ToFundGoodTimeDay";
	public static String note="货物每日增量表";//注释
	public static String tableName="to_fund_good_time_day";//实体表名
	 /**
