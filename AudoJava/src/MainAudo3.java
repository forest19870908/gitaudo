 ...
 *
 */
public class MainAudo3 {
//	public static String directory=".\\src\\file"; //相对目录
	public static String directory="D:\\java2\\workspace\\gylzsl27\\src"; //绝对目录
	public static String toFile="com.zsl.web.modules.jxc.model";
	public static String EntityName="JxcInventoryOutGod";
	public static String note="销售出库货到付款记录";//注释
	public static String tableName="z_company_trade_audit";//实体表名
	 /**
