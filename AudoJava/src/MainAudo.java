 ...
 *
 */
public class MainAudo {
//	public static String directory=".\\src\\file"; //相对目录
	public static String directory="D:\\java\\workspace\\gyl_zsl_v0.27\\src"; //绝对目录
	public static String toFile="com.zsl.web.modules.member.model";
	public static String EntityName="CompanyTradeAudit";
	public static String note="成交公司实体审批记录";//注释
