 ...
 *
 */
public class MainAudo6 {
//	public static String directory=".\\src\\file"; //相对目录
	public static String directory="D:\\java2\\workspace\\gylzsl029\\src"; //绝对目录
	public static String toFile="com.zsl.web.modules.jxc.model";
	public static String EntityName="CashOnDeliveryTempApply";
	public static String note="货到付款临时申请表";//注释
	public static String tableName="z_jxc_cash_on_delivery_temp_apply";//实体表名
	 /**
