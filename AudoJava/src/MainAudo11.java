...
//	public static String directory=".\\src\\file"; //相对目录
	...
	public static String EntityName="ToFundInventoryTime";
	public static String note="库存吨数分布表";//注释
	public static String tableName="to_fund_inventory_time";//实体表名
	 /**
