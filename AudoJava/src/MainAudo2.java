...
//	public static String directory=".\\src\\file"; //相对目录
	...
	public static String EntityName="ToFundDistributeTime";
	public static String note="资金分布实时表";//注释
	public static String tableName="to_fund_distribute_time";//实体表名
	 /**
