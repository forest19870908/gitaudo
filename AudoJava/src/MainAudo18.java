 ...
 *
 */
public class MainAudo18 {
//	public static String directory=".\\src\\file"; //相对目录
	public static String directory="D:\\java2\\workspace\\gylzsl29\\src"; //绝对目录
	public static String toFile="com.zsl.web.modules.jxc.model";
	public static String EntityName="JxcInventoryOutMatch";
	public static String note="匹配处理";//注释
	public static String tableName="z_gx_solution";//实体表名
	 /**
