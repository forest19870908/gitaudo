...
//	public static String directory=".\\src\\file"; //相对目录
	...
	public static String EntityName="CashOnDeliveryWhite";
	public static String note="货到付款白名单";//注释
	public static String tableName="z_jr_cash_on_delivery";//实体表名
	 /**
