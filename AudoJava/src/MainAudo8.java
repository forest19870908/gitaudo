 ...
 *
 */
public class MainAudo8 {
//	public static String directory=".\\src\\file"; //相对目录
	public static String directory="D:\\java2\\workspace\\gylzsl029\\src"; //绝对目录
	public static String toFile="com.zsl.web.modules.setting.model";
	public static String EntityName="DataRightsAllocation";
	public static String note="数据权限配置表(什么角色能看什么)";//注释
	public static String tableName="z_data_rights_allocation";//实体表名
	 /**
