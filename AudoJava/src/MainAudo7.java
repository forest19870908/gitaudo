...
//	public static String directory=".\\src\\file"; //相对目录
	...
	public static String EntityName="JxcGrossProfitOrg";
	public static String note="部门毛利初始表";//注释
	public static String tableName="z_jxc_gross_profit_org";//实体表名
	 /**
